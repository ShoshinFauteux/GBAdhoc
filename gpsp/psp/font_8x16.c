/* font_8x16.c -- classic VGA 8x16 bitmap font, 256 glyphs x 16 rows.
 *
 * Imported from the Linux kernel, lib/fonts/font_8x16.c
 * (SPDX-License-Identifier: GPL-2.0; "Font file generated by cpi2fnt").
 * License-compatible with this GPL-2.0 project (plan par.8: bundled
 * bitmap font). Data is byte-identical to the kernel table; one byte
 * per row, MSB = leftmost pixel.
 */
#include "font_8x16.h"

const unsigned char fe_font8x16[256 * 16] = {
